...
void LCD_ShowBlibli(void)
{
		u16 x,y;
		LCD_DrawRectangle(70, 100, 170, 180);		   				//画矩形
		LCD_DrawRectangle(80, 110, 160, 170);		   				//画矩形
		LCD_DrawLine(80, 80, 120, 100);							//画线
		LCD_DrawLine(160, 60, 130, 100);							//画线
		LCD_DrawLine(110, 125, 90, 133);							//画线
		LCD_DrawLine(130, 125, 150, 133);							//画线
		for( x=100;x<120;x++)				//画嘴
		{
		...
		for( x=0;x<20;x++)				//画脚
		{
			y=sqrt(100-(10-x)*(10-x))+180;
			LCD_Draw_Circle( x+95-10, y,1);
		}
		for( x=0;x<20;x++)
		{
			y=sqrt(100-(10-x)*(10-x))+180;
			LCD_Draw_Circle( x+145-10, y,1);
		}
}
